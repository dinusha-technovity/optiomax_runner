...
<head>
    ...
    <title>Asset Warranty Expired Alert</title>
</head>
    ...
    <div style="max-width: 600px; margin: 20px auto; overflow: hidden;">
        ...
        <div style="padding: 60px; text-align: left; background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 6px; margin: 10px 0;">
            ...
            <p style="font-size: 16px; color: #000;">
                This is an automated notification that the warranty for the following asset has expired:
            </p>
            ...
            <ul style="list-style: none; padding: 0; font-size: 16px; color: #000; margin-top: 25px;">
                ...
                <li><strong>Warranty Expired On:</strong> {{ $details->warranty_exparing_at }}</li>
                <li><strong>time:</strong> {{ $details->created_at }}</li>
            </ul>

            <p style="margin-top: 30px;">
                Please consider reviewing this asset for renewal or replacement, or initiate any required actions.
            </p>
            ...
            <div style="
                ...
                <div style="flex: 1; text-align: left;">
                    ...
                    <p style="margin: 0; font-size: 12px; color: #666666; line-height: 20px;">
                        Manage warranties and assets proactively. Stay ahead of your maintenance schedules with Optiomax.
                    </p>
                    <a href="#" style="
                        display: inline-block;
                        margin-top: 10px;
