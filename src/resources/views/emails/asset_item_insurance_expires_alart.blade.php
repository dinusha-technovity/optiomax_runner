...
<head>
    ...
    <title>Asset Insurance Expired Alert</title>
</head>
    ...
    <div style="max-width: 600px; margin: 20px auto; overflow: hidden;">
        ...
        <div style="padding: 60px; text-align: left; background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 6px; margin: 10px 0;">
            ...
            <p style="font-size: 16px; color: #000;">
                This is an automated notification that the insurance for the following asset has expired:
            </p>
            ...
            <ul style="list-style: none; padding: 0; font-size: 16px; color: #000; margin-top: 25px;">
                ...
                <li><strong>Insurance Expired On:</strong> {{ $details->insurance_exparing_at }}</li>
                <li><strong>time:</strong> {{ $details->created_at }}</li>
            </ul>

            <p style="margin-top: 30px;">
                Please review the insurance policy and take necessary steps to renew or replace it.
            </p>
            ...
            <div style="
                ...
                <div style="flex: 1; text-align: left;">
                    ...
                    <p style="margin: 0; font-size: 12px; color: #666666; line-height: 20px;">
                        Optiomax helps you stay compliant and avoid downtime by alerting you before your asset insurance expires.
                    </p>
                    <a href="#" style="
                        display: inline-block;
                        margin-top: 10px;
