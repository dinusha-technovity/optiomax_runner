...
<head>
    ...
    <title>Asset Maintenance Task Alert</title>
</head>
    ...
    <div style="max-width: 600px; margin: 20px auto; overflow: hidden;">
        ...
        <div style="
            ...
            <p style="margin: 30px 0 0; font-size: 36px; font-weight: bold; line-height: normal;">
                Maintenance Task Schedule Alert
            </p>
        </div>
        ...
        <div style="padding: 60px; text-align: left; background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 6px; margin: 10px 0;">
            ...
            <p style="font-size: 16px; color: #000;">
                This is an automated alert regarding a scheduled maintenance task for the following asset:
            </p>
            ...
            <p style="margin-top: 30px;">
                Please review and complete the task as per the defined schedule and ensure proper documentation.
            </p>
            ...
            <div style="
                ...
                <div style="flex: 1; text-align: left;">
                    ...
                    <p style="margin: 0; font-size: 12px; color: #666666; line-height: 20px;">
                        Automate and streamline your maintenance operations with Optiomax’s asset intelligence tools.
                    </p>
                    <a href="#" style="
                        display: inline-block;
                        margin-top: 10px;
