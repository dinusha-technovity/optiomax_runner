...
<head>
    ...
    <title>Asset Critically-Based Schedule Alert</title>
</head>
    ...
    <div style="max-width: 600px; margin: 20px auto; overflow: hidden;">
        ...
        <div style="
            ...
            <p style="margin: 30px 0 0; font-size: 36px; font-weight: bold; line-height: normal;">
                Critically-Based Maintenance Alert
            </p>
        </div>
        ...
        <div style="padding: 60px; text-align: left; background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 6px; margin: 10px 0;">
            ...
            <p style="font-size: 16px; color: #000;">
                A critically-based schedule alert has been triggered for one of your assigned assets. Below are the details:
            </p>
            ...
            <ul style="list-style: none; padding: 0; font-size: 16px; color: #000; margin-top: 25px;">
                ...
                <li><strong>Reading Required:</strong> {{ $details->reading_parameters }}</li>
                <li><strong>Assessment:</strong> {{ $details->assessment_description }}</li>
                <li><strong>Expected Result:</strong> {{ $details->expected_results }}</li>
                <li><strong>Comments:</strong> {{ $details->comments }}</li>
                <li><strong>time:</strong> {{ $details->created_at }}</li>
            </ul>

            <p style="margin-top: 30px;">
                Please assess the condition and perform the recommended checks or corrective actions as per the maintenance policy.
            </p>
            ...
            <div style="
                ...
                <div style="flex: 1; text-align: left;">
                    ...
                    <p style="margin: 0; font-size: 12px; color: #666666; line-height: 20px;">
                        Monitor asset health, receive alerts, and stay on top of critical maintenance events—all from one dashboard.
                    </p>
                    <a href="#" style="
                        display: inline-block;
                        margin-top: 10px;
