...
class ItemCsvImportService
{
    ...
    public function __construct()
    {
        ...
        $this->csvColumnMapping = [
            ...
            // image_links is excluded - will be set to null
        ];
    }
     ...
     */
    public function bulkInsertItems(array $transformedData, int $userId, int $tenantId, int $jobId = null): array
    {
        try {
            // Log the bulk insert operation
            Log::info('Calling bulk_insert_items_with_relationships', [
                'job_id' => $jobId,
    ...
    public function generateCsvTemplate(): array
    {
        ...
        return [
            ...
            'lookup_instructions' => [
                ...
                'validation_notes' => 'Categories will be created automatically if they do not exist. Item names must be unique within tenant. Note: image_links will be set to null and should be managed separately.'
            ]
        ];
    }
