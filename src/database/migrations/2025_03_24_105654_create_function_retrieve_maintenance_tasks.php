...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
            CREATE OR REPLACE FUNCTION get_maintenance_tasks(
                _tenant_id BIGINT,
            ...
            BEGIN
                ...
                WHERE (p_id IS NULL OR mt.id = p_id)
                AND (p_asset_id IS NULL OR mt.asset = p_asset_id)
                AND mt.tenant_id = _tenant_id
                AND mt.deleted_at IS NULL;
            END;
            $$;
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS get_maintenance_tasks');
    }
};