...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        //                 asset_id, start_datetime, end_datetime, title, publish_status, visibility_id,
        //                 approval_type_id, rate, rate_currency_type_id, rate_period_type_id,
        //                 deposit_required, deposit_amount, description, recurring_enabled, recurring_pattern,
        //                 recurring_config, attachment, created_by, is_active, tenant_id, created_at, updated_at,
        //                 cancellationEnabled, cancellation_notice_period_type, cancellation_fee_enabled,
        //                 cancellation_fee_type, cancellation_fee_amount, cancellation_fee_percentage,
        //                 asset_booking_cancellation_refund_policy_type
        //             ) VALUES (
        //                 p_asset_id, p_start_datetime, p_end_datetime, p_title, p_publish_status, p_visibility_id,
        //                 p_approval_type_id, p_rate, p_rate_currency_type_id, p_rate_period_type_id,
        //                 p_deposit_required, p_deposit_amount, p_description, p_recurring_enabled, p_recurring_pattern,
        //                 p_recurring_config, p_attachment, p_created_by, p_is_active, p_tenant_id, p_current_time, p_current_time,
        //                 p_cancellation_enabled, p_cancellation_notice_period_type, p_cancellation_fee_enabled,
        //                 p_cancellation_fee_type, p_cancellation_fee_amount, p_cancellation_fee_percentage,
        //                 p_asset_booking_cancellation_refund_policy_type
        ...
        //                 LOOP
        //                     INSERT INTO asset_availability_schedule_term_types(asset_availability_schedule_id, term_type_id, created_at, updated_at)
        //                     VALUES (v_id, (v_term_type->>'id')::BIGINT, p_current_time, p_current_time);
        //                 END LOOP;
        //             END IF;
        ...
        //                 LOOP
        //                     INSERT INTO asset_availability_required_documents_for_booking(asset_availability_schedule_id, document_category_field_id, created_at, updated_at)
        //                     VALUES (v_id, (v_required_doc->>'field_id')::BIGINT, p_current_time, p_current_time);
        //                 END LOOP;
        //             END IF;
        ...
        //                 'cancellationEnabled', p_cancellation_enabled,
        ...
        //                 DELETE FROM asset_availability_schedule_term_types WHERE asset_availability_schedule_id = v_id;
        //                 IF p_term_types IS NOT NULL THEN
        //                     FOR v_term_type IN SELECT * FROM jsonb_array_elements(p_term_types)
        //                     LOOP
        //                         INSERT INTO asset_availability_schedule_term_types(asset_availability_schedule_id, term_type_id, created_at, updated_at)
        ...
        //                 DELETE FROM asset_availability_required_documents_for_booking WHERE asset_availability_schedule_id = v_id;
        //                 IF p_required_documents IS NOT NULL THEN
        //                     FOR v_required_doc IN SELECT * FROM jsonb_array_elements(p_required_documents)
        //                     LOOP
        //                         INSERT INTO asset_availability_required_documents_for_booking(asset_availability_schedule_id, document_category_field_id, created_at, updated_at)
