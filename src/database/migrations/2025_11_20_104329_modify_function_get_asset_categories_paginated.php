        ...
        DB::unprepared(<<<'SQL'
            ...
            BEGIN
                FOR r IN
                    ...
                    FROM pg_proc
                    WHERE proname = 'get_asset_categories'
                LOOP
            ...
            CREATE OR REPLACE FUNCTION get_asset_categories(
                p_tenant_id BIGINT,
                p_asset_categories_id BIGINT DEFAULT NULL,
            ...
            BEGIN
                ...
                SELECT 
                    ...
                    ac.reading_parameters,
                    ac.assets_type as asset_type
                FROM asset_categories ac
                ...
                AND (
                    %L IS NULL OR
                    ac.name ILIKE '%%' || %L || '%%' OR
                    ac.description ILIKE '%%' || %L || '%%'
                )
                %s
                LIMIT %s OFFSET %s
            $SQL$,
                p_tenant_id,
                p_asset_categories_id,  -- %L
                p_asset_categories_id,  -- %L
                p_search,               -- %L
                p_search,               -- %L
                p_search,               -- %L
