...
return new class extends Migration
{
    ...
    {
        DB::unprepared(
            "CREATE OR REPLACE PROCEDURE STORE_PROCEDURE_INSERT_OR_UPDATE_DASHBOARD_APP_LAYOUT_WIDGET(
            ...
            BEGIN
                DROP TABLE IF EXISTS dashboard_app_layout_widget_response_from_store_procedure;
                CREATE TEMP TABLE dashboard_app_layout_widget_response_from_store_procedure (
                    status TEXT,
                    message TEXT,
                ...
                BEGIN
                    IF p_id IS NULL OR p_id = 0 THEN
                        ...
                        IF NOT FOUND THEN
                            ...
                            INSERT INTO dashboard_app_layout_widget_response_from_store_procedure (status, message, widget_id)
    ...
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS STORE_PROCEDURE_INSERT_OR_UPDATE_DASHBOARD_APP_LAYOUT_WIDGET');
    }
};
