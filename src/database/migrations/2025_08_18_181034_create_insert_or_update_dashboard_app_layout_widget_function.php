...
return new class extends Migration
{
    ...
    {
        DB::unprepared("DROP FUNCTION IF EXISTS insert_or_update_dashboard_app_layout_widget(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, TEXT, BIGINT, TEXT, BIGINT, VARCHAR, BIGINT, BOOLEAN, TIMESTAMPTZ, BIGINT);");
    }
};