        ...
        DB::unprepared(<<<SQL
            ...
            BEGIN
                IF p_id IS NULL OR p_id = 0 THEN
                    ...
                    RETURN QUERY SELECT 'SUCCESS', 'Incident report submitted successfully', return_id;
                ...
                ELSE
                    ...
                    IF FOUND THEN
                        ...
                        RETURN QUERY SELECT 'SUCCESS', 'Incident report updated successfully', return_id;
                    ELSE
                        RETURN QUERY SELECT 'FAILURE', format('Incident report with ID %s not found', p_id), NULL::BIGINT;
                    END IF;
                END IF;
            END;
            \$\$;
