...
return new class extends Migration
{
    public function up(): void
    {
        ...
        RETURNS TABLE (
            ...
            asset_responsible_person_id BIGINT,
            asset_responsible_person_name TEXT,
            asset_responsible_person_email TEXT,
            asset_responsible_person_contact_no TEXT,
            asset_responsible_person_description TEXT,
            asset_responsible_person_profile_image TEXT,
            asset_responsible_person_designation_id BIGINT,
            asset_responsible_person_designation TEXT,
            ...
            report_created_by_contact_no TEXT,
            report_created_by_description TEXT,
            report_created_by_profile_image TEXT,
            report_created_by_designation_id BIGINT,
            report_created_by_designation TEXT,
        ...
        BEGIN
            ...
            WITH data AS (
                SELECT
                    ...
                    ai.responsible_person AS asset_responsible_person_id,
                    urp.name::TEXT AS asset_responsible_person_name,
                    urp.email::TEXT AS asset_responsible_person_email,
                    urp.contact_no::TEXT AS asset_responsible_person_contact_no,
                    urp.user_description::TEXT AS asset_responsible_person_description,
                    urp.profile_image::TEXT AS asset_responsible_person_profile_image,
                    urp.designation_id AS asset_responsible_person_designation_id,
                    drp.designation::TEXT AS asset_responsible_person_designation,
                    ...
                    uc.email::TEXT AS report_created_by_email,
                    uc.contact_no::TEXT AS report_created_by_contact_no,
                    uc.user_description::TEXT AS report_created_by_description,
                    uc.profile_image::TEXT AS report_created_by_profile_image,
                    uc.designation_id AS report_created_by_designation_id,
                    dc.designation::TEXT AS report_created_by_designation,
                ...
                LEFT JOIN users urp ON ai.responsible_person = urp.id
                LEFT JOIN designations drp ON urp.designation_id = drp.id
                ...
                LEFT JOIN designations dc ON uc.designation_id = dc.id
            ...
            SELECT
                ...
                d.asset_responsible_person_id,
                d.asset_responsible_person_name,
                d.asset_responsible_person_email,
                d.asset_responsible_person_contact_no,
                d.asset_responsible_person_description,
                d.asset_responsible_person_profile_image,
                d.asset_responsible_person_designation_id,
                d.asset_responsible_person_designation,
                ...
                d.report_created_by_email,
                d.report_created_by_contact_no,
                d.report_created_by_description,
                d.report_created_by_profile_image,
                d.report_created_by_designation_id,
                d.report_created_by_designation,
