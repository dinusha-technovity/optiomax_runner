...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
            DROP FUNCTION IF EXISTS insert_or_update_asset_availability_schedule(
                BIGINT, TIMESTAMPTZ, TIMESTAMPTZ, BIGINT, BIGINT, VARCHAR,
                BIGINT, BIGINT, BIGINT, NUMERIC, BIGINT, BIGINT, BOOLEAN,
                NUMERIC, TEXT, BOOLEAN, VARCHAR, JSONB, BIGINT, VARCHAR,
                BOOLEAN, TIMESTAMPTZ
            );
    ...
    public function down(): void
    {
        DB::unprepared(<<<SQL
            DROP FUNCTION IF EXISTS insert_or_update_asset_availability_schedule(
            BIGINT, TIMESTAMPTZ, TIMESTAMPTZ, BIGINT, VARCHAR(250), BIGINT, VARCHAR, BIGINT, BIGINT, BIGINT, NUMERIC, BIGINT, BIGINT, BOOLEAN, NUMERIC, TEXT, BOOLEAN, VARCHAR, JSONB, JSONB,
            BIGINT, VARCHAR, BOOLEAN, TIMESTAMPTZ );
        SQL);
    }
};