...
return new class extends Migration
{
                ...
                IF v_exists THEN
                    ...
                    IF p_selected_requisition_items IS NOT NULL THEN
                        ...
                        LOOP
                            ...
                            END IF;                        -- Insert purchasing order item
                           ...
                           --update finalized item is_po_submit and pending_purchasing_qty to minimize
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS insert_or_update_purchasing_order(BIGINT, BIGINT, TEXT);');
    }
};
