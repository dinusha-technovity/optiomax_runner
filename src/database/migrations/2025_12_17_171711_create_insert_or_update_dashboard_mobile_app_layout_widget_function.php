...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
            CREATE OR REPLACE FUNCTION insert_or_update_dashboard_mobile_app_layout_widget(
            ...
            BEGIN
                ...
                IF p_id IS NULL OR p_id = 0 THEN
                    ...
                    IF NOT FOUND THEN
                        INSERT INTO mobile_app_layout_widgets (
                    ...
                    ELSE
                        UPDATE mobile_app_layout_widgets alw
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS insert_or_update_dashboard_mobile_app_layout_widget();');
    }
};
