...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
            CREATE OR REPLACE FUNCTION insert_or_update_asset_manufacturer_maintain_schedules(
                IN p_asset BIGINT,
            ...
            BEGIN
                ...
                IF p_schedule_id IS NULL OR p_schedule_id = 0 THEN
                    -- Insert new record
                    INSERT INTO asset_manufacturer_recommendation_maintain_schedules (
                        asset, 
                    ...
                    RETURNING id, to_jsonb(asset_manufacturer_recommendation_maintain_schedules.*) INTO p_inserted_or_updated_schedule_id, new_record;
                ...
                ELSE
                    ...
                    SELECT to_jsonb(asset_manufacturer_recommendation_maintain_schedules.*) INTO old_record
                    FROM asset_manufacturer_recommendation_maintain_schedules
                    WHERE id = p_schedule_id;

                    -- Update existing record
                    UPDATE asset_manufacturer_recommendation_maintain_schedules
                    SET 
                        asset = p_asset,
                    ...
                    SELECT to_jsonb(asset_manufacturer_recommendation_maintain_schedules.*) INTO new_record
                    FROM asset_manufacturer_recommendation_maintain_schedules
                    WHERE id = p_schedule_id;
