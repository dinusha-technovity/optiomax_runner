...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('replace_asset_requisitions', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('expected_condition')->nullable();
            ...
            $table->foreign('expected_condition')->references('id')->on('asset_received_condition_types')->onDelete('restrict');
