                ...
                BEGIN
                    ...
                    IF _tenant_id IS NULL OR _tenant_id <= 0 THEN
                        RETURN QUERY SELECT 
                            ...
                            NULL::TEXT, NULL::TEXT, NULL::JSON, NULL::JSON, NULL::JSON, 
                    ...
                    INNER JOIN asset_categories ac ON a.category = ac.id  -- Moved this before the assets_types join
                    INNER JOIN assets_types ast ON ac.assets_type = ast.id  -- Now ac is available
