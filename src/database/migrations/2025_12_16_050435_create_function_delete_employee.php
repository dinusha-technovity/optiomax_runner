            ...
            BEGIN
                ...
                IF NOT FOUND THEN
                    RETURN QUERY SELECT
                        ...
                        'Employee not found or already deleted'::TEXT AS message;
                    RETURN;
                END IF;
                ...
                IF rows_updated > 0 THEN
                    ...
                    IF p_user_id IS NOT NULL THEN
                        BEGIN
                            PERFORM log_activity(
                                'employee.deleted',
                                'Employee deleted: ' || p_employee_id,
                                'employee',
                                p_employee_id,
                                'user',
                                p_user_id,
                    ...
                    RETURN QUERY SELECT
                        ...
                        'Employee deleted successfully'::TEXT AS message;
                ELSE
                    RETURN QUERY SELECT
                        'FAILURE'::TEXT AS status,
                        'No rows updated. Employee not found or already deleted.'::TEXT AS message;
                END IF;
            END;
            $$;
        SQL);
