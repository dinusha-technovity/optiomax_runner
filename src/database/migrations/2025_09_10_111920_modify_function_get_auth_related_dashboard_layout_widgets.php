...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
            DROP FUNCTION IF EXISTS get_auth_related_dashboard_layout_widgets(
                p_tenant_id BIGINT,
                p_user_id BIGINT,
                p_layout_id BIGINT
            );

            CREATE OR REPLACE FUNCTION get_auth_related_dashboard_layout_widgets(
                p_tenant_id BIGINT,
                p_user_id BIGINT,
    ...
    {
        DB::unprepared("DROP FUNCTION IF EXISTS get_auth_related_dashboard_layout_widgets(BIGINT, BIGINT, BIGINT);");
    }
};