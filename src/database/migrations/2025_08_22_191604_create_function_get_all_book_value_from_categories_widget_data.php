...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
        CREATE OR REPLACE FUNCTION get_all_book_values_from_categories_widget_data(
                p_tenant_id BIGINT,
                p_date DATE,
        ...
        BEGIN
            ...
            all_categories AS (
                SELECT 
                    ...
                    ROUND((total_book_value / SUM(total_book_value) OVER() * 100)::numeric, 1) as percentage
    ...
    {
        DB::unprepared("DROP FUNCTION IF EXISTS get_all_book_values_from_categories_widget_data(BIGINT, TEXT, DATE);");
    }
};
