        ...
        DB::unprepared(<<<SQL
            ...
            BEGIN
                FOR r IN
                    ...
                    FROM pg_proc
                    WHERE proname = 'delete_asset_item'
                LOOP
            ...
            BEGIN
                ...
                IF rows_updated > 0 THEN
                        ...
                        PERFORM change_supplier_asset_stats((deleted_data->>'supplier')::BIGINT, 'DELETE', p_tenant_id);
                        PERFORM calculate_supplier_rating((deleted_data->>'supplier')::BIGINT, 'FULL_RECALC', '{}'::JSONB, p_tenant_id);
