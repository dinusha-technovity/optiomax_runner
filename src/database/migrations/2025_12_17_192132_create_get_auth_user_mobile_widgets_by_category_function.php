...
return new class extends Migration
{
    ...
    { 
        DB::unprepared(<<<SQL
            CREATE OR REPLACE FUNCTION get_auth_user_mobile_widgets_by_category(
            ...
            BEGIN
                ...
                WITH widget_data AS (
                    ...
                    AND w.is_enable_for_mobile_app = TRUE
    ...
    {
        DB::unprepared("DROP FUNCTION IF EXISTS get_auth_user_mobile_widgets_by_category(INT, BIGINT);");
    }
};