...
return new class extends Migration
{
    ...
    {
        // DB::unprepared(<<<SQL
        //     DROP FUNCTION IF EXISTS get_asset_availability_schedules(BIGINT, TIMESTAMP, TIMESTAMP, TEXT);
        ...
        DB::unprepared(<<<SQL
            DROP FUNCTION IF EXISTS get_asset_availability_schedules(
                BIGINT, TEXT, BIGINT, BIGINT, TIMESTAMPTZ, TIMESTAMPTZ
            );
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS get_asset_availability_schedules(BIGINT, TEXT, BIGINT, BIGINT, TIMESTAMPTZ, TIMESTAMPTZ)');
    }
};
