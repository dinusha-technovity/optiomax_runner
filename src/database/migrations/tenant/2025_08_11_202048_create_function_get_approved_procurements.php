...
return new class extends Migration
{
    ...
    {
        DB::unprepared("DROP FUNCTION IF EXISTS get_procurements_by_status(BIGINT, TEXT);");

        DB::unprepared(<<<SQL
            CREATE OR REPLACE FUNCTION get_procurements_by_status(
            ...
            BEGIN
                ...
                SELECT
                    ...
                    CASE 
                        WHEN p.selected_items IS NULL THEN 0
                        ELSE jsonb_array_length(p.selected_items)
                    END AS selected_items_count,
                    p.created_by,
                    u_creator.name::TEXT,
                    p.created_at,
                ...
                AND (p_status IS NULL OR p.procurement_status = p_status)
                AND EXISTS (
                    SELECT 1
