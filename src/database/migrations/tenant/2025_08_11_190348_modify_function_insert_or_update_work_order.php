...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
            DROP FUNCTION IF EXISTS insert_or_update_work_order(
                BIGINT, TEXT, TEXT, BIGINT, BIGINT, BIGINT, BIGINT, BIGINT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT,
                TIMESTAMPTZ, TIMESTAMPTZ, INTEGER, TEXT, NUMERIC, NUMERIC, JSONB, JSONB, JSONB, BIGINT, BIGINT, TEXT,
                TIMESTAMPTZ, TIMESTAMPTZ, TEXT, JSONB, TEXT, JSONB
            );
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS insert_or_update_work_order( BIGINT, TEXT, TEXT, BIGINT, BIGINT, BIGINT, BIGINT, BIGINT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TIMESTAMPTZ, TIMESTAMPTZ, INTEGER, TEXT, NUMERIC, NUMERIC, JSONB, JSONB, JSONB, BIGINT, BIGINT, TEXT, TIMESTAMPTZ, TIMESTAMPTZ, TEXT, JSONB, TEXT, JSONB);');
    }
};