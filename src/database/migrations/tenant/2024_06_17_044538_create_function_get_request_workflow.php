...
return new class extends Migration
{
    ...
    { 
        ...
        // DB::unprepared(<<<SQL
        //     CREATE OR REPLACE FUNCTION get_request_workflow(
        //         p_workflow_id BIGINT,
        ...
        //             SELECT UPPER(wt.workflow_type)
        //             INTO workflow_type
        //             FROM public.workflow_details wd
        //             JOIN public.workflow_types wt
        //             ON wd.workflow_detail_type_id = wt.id
        //             WHERE wd.id = current_node.id;
        ...
        //         IF last_approved_node IS NOT NULL THEN
        //             RETURN QUERY SELECT
        //                 'success',
        //                 last_approved_node.id,
        //                 last_approved_node.workflow_detail_parent_id,
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS get_request_workflow');
    }
};