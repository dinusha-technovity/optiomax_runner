        ...
        DB::unprepared(<<<SQL
            ...
            BEGIN
                FOR r IN
                    ...
                    FROM pg_proc
                    WHERE proname = 'submit_asset_requisition'
                LOOP
            ...
            BEGIN
              -- ─── Generate Requisition Numbers ───
                ...
                asset_requisition_register_id := 'AST-REQ-' || v_current_year || '-' || LPAD(curr_val::TEXT, 4, '0');
                ...
                ELSE
                    ...
                    INSERT INTO asset_requisitions (
                        requisition_id, requisition_by, requisition_date, requisition_status, tenant_id, created_at, updated_at, asset_requisition_type_id
                    )
                    VALUES (
                        asset_requisition_register_id, _user_id, _current_time, _requisition_status, _tenant_id, _current_time, _current_time, 1
                    )
                    RETURNING id, to_jsonb(asset_requisitions.*) INTO v_asset_requisition_id, new_data;
                END IF;
