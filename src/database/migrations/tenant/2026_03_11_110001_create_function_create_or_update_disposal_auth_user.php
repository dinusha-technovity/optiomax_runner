...
return new class extends Migration
{
    /**
     * Run the migrations.
     * PostgreSQL Function: Create or Update Disposal Authorization User
     * 
     * This function handles the creation and updating of disposal authorization records
     * with automatic registration number generation (DAU-XXXXXX format),
     * comprehensive validation, and activity logging integration.
     * 
     * @see ISO 55001:2014 - Asset Disposal Authorization Standards
     */
            ...
            BEGIN
                ...
                IF p_disposal_auth_id IS NULL THEN
                    ...
                    IF v_existing_count > 0 THEN
                        RETURN jsonb_build_object(
                            'status', 'ERROR',
                            'message', 'User already has a disposal authorization record'
                        );
                    END IF;
