...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Recreate process_employee_approvers function (no changes needed)
        DB::unprepared(<<<'SQL'
        ...
        // Recreate process_designation_approvers function (no changes needed)
        DB::unprepared(<<<'SQL'
        ...
        // Recreate get_workflow_alert_data_relevant_approver function with filters
        DB::unprepared(<<<'SQL'
