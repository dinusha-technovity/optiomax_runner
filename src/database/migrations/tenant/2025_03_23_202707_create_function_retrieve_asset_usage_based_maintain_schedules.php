...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
            CREATE OR REPLACE FUNCTION get_asset_usage_based_maintain_schedules(
                _tenant_id BIGINT,
            ...
            BEGIN
                ...
                FROM asset_usage_based_maintain_schedules amrms
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS get_asset_usage_based_maintain_schedules');
    }
};