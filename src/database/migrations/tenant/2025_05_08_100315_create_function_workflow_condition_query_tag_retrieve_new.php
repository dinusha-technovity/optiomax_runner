...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
        DROP FUNCTION IF EXISTS get_all_workflow_condition_query_tag(BIGINT, INT);
        ...
        BEGIN
            ...
            SELECT
                'SUCCESS'::TEXT,
                'Asset query tag fetched successfully'::TEXT,
                wcqt.id,
                wcqt.name::TEXT,
                wcqt.value::TEXT,
                wcqt.query::TEXT,
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS get_all_workflow_condition_query_tag(BIGINT, INT);');
    }
};
