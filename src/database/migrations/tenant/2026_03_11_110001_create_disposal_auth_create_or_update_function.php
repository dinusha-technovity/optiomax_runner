...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Function: Create or Update Disposal Authorization User
     * 
     * This function handles both creation and updates of disposal authorization records.
     * It includes validation, registration number generation, and activity logging.
     * 
        ...
        DB::unprepared(<<<'SQL'
            ...
            BEGIN
                ...
                IF p_disposal_auth_id IS NULL THEN
                    ...
                    -- Set default authorized_from to current date if not provided (for new authorizations)
                    IF p_authorized_from IS NULL THEN
                        p_authorized_from := CURRENT_DATE;
                    END IF;
