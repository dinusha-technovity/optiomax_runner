...
return new class extends Migration
{
    ...
    { 
        Schema::create('employee_asset_scheduling_occurrences', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('schedule_id')->references('id')->on('employee_asset_scheduling')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('employee_asset_scheduling_occurrences');
    }
};