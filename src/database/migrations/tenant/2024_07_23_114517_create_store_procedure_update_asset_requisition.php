        ...
        DB::unprepared(
            ...
            BEGIN
                ...
                LOOP
                    UPDATE asset_requisitions_items
                    SET
                        item_count = (item_record->>'quantity')::BIGINT,  -- Assuming quantity is always an integer
                        requested_budget = (item_record->>'budget')::NUMERIC  -- Casting budget as NUMERIC to handle decimal values
                    WHERE id = (item_record->>'id')::INT RETURNING id INTO return_id;
                END LOOP;
            END;
            $$;"
