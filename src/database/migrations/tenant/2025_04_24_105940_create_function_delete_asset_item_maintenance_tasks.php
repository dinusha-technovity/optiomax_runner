...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
            CREATE OR REPLACE FUNCTION delete_asset_item_maintenance_task(
                p_task_id BIGINT,
                p_tenant_id BIGINT,
            ...
            BEGIN
                ...
                SELECT EXISTS(
                    SELECT 1 FROM asset_item_maintenance_tasks
                    WHERE id = p_task_id
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS delete_asset_item_maintenance_task');
    }
};