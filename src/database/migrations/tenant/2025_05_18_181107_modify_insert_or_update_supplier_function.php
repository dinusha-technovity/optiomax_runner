    ...
    public function up(): void
    {
        DB::unprepared(<<<SQL
                DROP FUNCTION IF EXISTS insert_or_update_supplier(
                    VARCHAR, VARCHAR, TEXT, VARCHAR, JSON, BIGINT,
                ...
                BEGIN
                    ...
                    IF p_id IS NULL OR p_id = 0 THEN
                        INSERT INTO suppliers (
                            ...
                            mobile_no_code, contact_no_code, country, city, email, asset_categories -- Add new columns here
                        )
                        VALUES (
                            ...
                            p_mobile_no_code, p_contact_no_code, p_country, p_city, p_email, p_asset_categories -- Add new column values here
                        )
