...
return new class extends Migration
{
        ...
        DB::unprepared(<<<SQL
            ...
            BEGIN
                FOR r IN
                    ...
                    FROM pg_proc
                    WHERE proname = 'insert_or_update_asset_availability_blockout_schedule'
                LOOP
            ...
            BEGIN
                ...
                IF p_id IS NULL THEN
                    ...
                    INSERT INTO asset_availability_blockout_schedules(
                        asset_id, block_start_datetime, block_end_datetime, title, publish_status, reason_type_id,
                        custom_reason, description, recurring_enabled, recurring_pattern, recurring_config, attachment,
                        created_by, is_active, tenant_id, deleted_at, created_at, updated_at
                    ) VALUES (
                        p_asset_id, p_block_start_datetime, p_block_end_datetime, p_title, p_publish_status, p_reason_type_id,
                        p_custom_reason, p_description, p_recurring_enabled, p_recurring_pattern, p_recurring_config,
                        p_attachment, p_created_by, p_is_active, p_tenant_id, p_deleted_at, p_current_time, p_current_time
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS insert_or_update_asset_availability_blockout_schedule(BIGINT, TIMESTAMPTZ, TIMESTAMPTZ, VARCHAR, VARCHAR, BIGINT, VARCHAR, TEXT, BOOLEAN, VARCHAR, JSONB, BIGINT, BOOLEAN, BIGINT, BIGINT, TIMESTAMPTZ, VARCHAR, TIMESTAMPTZ);');
    }
};