...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        CREATE OR REPLACE FUNCTION insert_or_update_employee_asset_scheduling(
            ...
            IN p_assignee_type BIGINT DEFAULT 1,
        ...
        BEGIN
            ...
            ELSIF p_assignee_type = 2 THEN
                ...
                END IF;
            ELSE
                RETURN QUERY SELECT 'FAILURE'::TEXT, 'Invalid assignee type. Must be either 1 (Individual) or 2 (Group)'::TEXT, NULL::BIGINT;
                RETURN;
            END IF;
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS insert_or_update_employee_asset_scheduling(BIGINT, TIMESTAMPTZ, TIMESTAMPTZ, BIGINT, BIGINT, JSONB, TEXT, VARCHAR, BOOLEAN, VARCHAR, JSONB, BIGINT, VARCHAR, BOOLEAN, TIMESTAMPTZ, BIGINT)');
    }
};
