...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DECLARE
            ...
            v_leader_designation TEXT;
            v_leader_email TEXT;
            v_leader_contact TEXT;
        BEGIN
            -- Validate tenant ID
            ...
            LOOP
                ...
                SELECT mtm.user_id, u.name, u.profile_image, d.designation, u.email, u.contact_no
                INTO v_leader_id, v_leader_name, v_leader_profile_image, v_leader_designation, v_leader_email, v_leader_contact
                FROM maintenance_team_members mtm
                INNER JOIN users u ON u.id = mtm.user_id
                ...
                v_leader_designation := NULL;
                v_leader_email := NULL;
                v_leader_contact := NULL;
            END LOOP;
