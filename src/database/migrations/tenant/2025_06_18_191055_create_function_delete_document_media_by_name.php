...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
            CREATE OR REPLACE FUNCTION delete_document_media_by_name(
            p_stored_file_name VARCHAR,
            p_tenant_id BIGINT,
        ...
        BEGIN
            ...
            FROM document_media
            WHERE stored_name = p_stored_file_name
    ...
    {
         DB::unprepared('DROP FUNCTION IF EXISTS delete_document_media_by_name(VARCHAR, BIGINT, TIMESTAMP WITH TIME ZONE, BIGINT, VARCHAR);');
    }
};
