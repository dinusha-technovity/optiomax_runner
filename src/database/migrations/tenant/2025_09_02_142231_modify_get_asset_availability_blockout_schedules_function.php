...
return new class extends Migration
{
        ...
        DB::unprepared(<<<SQL
            ...
            BEGIN
                ...
                SELECT
                    ...
                    -- (b.block_start_datetime AT TIME ZONE 'UTC' AT TIME ZONE p_timezone)::timestamptz AS block_start_datetime,
                    -- (b.block_end_datetime AT TIME ZONE 'UTC' AT TIME ZONE p_timezone)::timestamptz AS block_end_datetime,
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS get_asset_availability_blockout_schedules(BIGINT, TEXT, BIGINT, BIGINT, TIMESTAMPTZ, TIMESTAMPTZ)');
    }
};
