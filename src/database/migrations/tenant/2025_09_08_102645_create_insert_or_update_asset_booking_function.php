...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        //         IN p_time_slots JSONB, -- Array of slot objects
        //         IN p_user_id BIGINT,   -- For logging
        //         IN p_user_name VARCHAR, -- For logging
        //         IN p_current_time TIMESTAMPTZ DEFAULT now(),
        //         IN p_id BIGINT DEFAULT NULL,
        //         IN p_prefix TEXT DEFAULT 'ASBK'  -- Prefix for register number
        //     )
        //     RETURNS TABLE (
        //         status TEXT,
        //         message TEXT,
        ...
        //                 purpose, attendees_count, special_requirements, rate_applied, currency_code,
        ...
        //                 p_purpose, p_attendees_count, p_special_requirements, p_rate_applied, p_currency_code,
        ...
        //                     ) VALUES (
        //                         new_booking_id,
        //                         (slot_record->>'availabilityScheduleId')::bigint,
        ...
        //                     ELSIF approval_type = 2 OR approval_type = 3 THEN
        ...
        //             -- Return all asset_booking_time_slots with approval_type_id = 3 for this booking
        //             RETURN QUERY
        //             SELECT
        //                 'INFO'::TEXT,
        //                 'Approval type 3 slots'::TEXT,
        //                 booking_id,
        //                 approval_status
        //             FROM asset_booking_time_slots
        //             WHERE booking_id = new_booking_id AND approval_type_id = 3;
            ...
            BEGIN
                ...
                IF p_id IS NULL OR p_id = 0 THEN
                    ...
                    SELECT
                        ...
                        NULL::VARCHAR,
                        t.id,
                        t.approval_status::TEXT    -- <--- critical fix
                    FROM asset_booking_time_slots t
                    WHERE t.booking_id = new_booking_id AND t.approval_type_id = 3;
