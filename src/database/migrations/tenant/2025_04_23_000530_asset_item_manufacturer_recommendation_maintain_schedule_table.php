...
return new class extends Migration
{
    ...
    {
        Schema::create('asset_item_manufacturer_recommendation_maintain_schedules', function (Blueprint $table) {
            $table->id(); 
    ...
    {
        Schema::dropIfExists('asset_item_manufacturer_recommendation_maintain_schedules');
    }
};
