...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
            CREATE OR REPLACE FUNCTION delete_asset_item_usage_based_maintenance_schedule(
            ...
            BEGIN
                ...
                SELECT EXISTS(
                    SELECT 1 FROM asset_item_usage_based_maintain_schedules
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS delete_asset_item_usage_based_maintenance_schedule');
    }
};
