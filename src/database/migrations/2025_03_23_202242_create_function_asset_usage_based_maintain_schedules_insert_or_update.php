...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
            CREATE OR REPLACE FUNCTION insert_or_update_asset_usage_maintain_schedules(
                IN p_asset BIGINT,
            ...
            BEGIN
                ...
                IF p_schedule_id IS NULL OR p_schedule_id = 0 THEN
                    -- Insert new record
                    INSERT INTO asset_usage_based_maintain_schedules (
                        asset, 
                    ...
                    RETURNING id, to_jsonb(asset_usage_based_maintain_schedules.*) INTO p_inserted_or_updated_schedule_id, new_record;
                ...
                ELSE
                    ...
                    SELECT to_jsonb(asset_usage_based_maintain_schedules.*) INTO old_record
                    ...
                    SELECT to_jsonb(asset_usage_based_maintain_schedules.*) INTO new_record
                    FROM asset_usage_based_maintain_schedules
                    WHERE id = p_schedule_id;
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS insert_or_update_asset_usage_maintain_schedules');
    }
};