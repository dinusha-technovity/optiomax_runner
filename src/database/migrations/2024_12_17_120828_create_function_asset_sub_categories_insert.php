...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<SQL
        CREATE OR REPLACE FUNCTION insert_asset_sub_categories(
            IN _categories_name VARCHAR(255),
            IN _categories_description TEXT,
            IN _asset_category BIGINT,
        ...
        BEGIN
            ...
            IF existing_count > 0 THEN
                ...
                RETURN QUERY SELECT 
                    ...
                    NULL::BIGINT AS category_id;
            ELSE
                -- Insert into asset_sub_categories and get the generated ID
                ...
                RETURN QUERY SELECT 
                    ...
                    'Asset sub-category inserted successfully'::TEXT AS message, 
                    category_id;
            END IF;
        END;
        $$;
    ...
    {
        DB::unprepared('DROP FUNCTION IF EXISTS insert_asset_sub_categories');
    }
};