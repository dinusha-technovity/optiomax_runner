...
class DocumentCategoryFieldSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $rows = [
            ...
            [
                'id' => 68,
                'document_category_id' => 31,
                'document_field_name' => "Error Logs/Performance Reports",
                'description' => "System or application error logs or performance reports used for troubleshooting and debugging",
                'file_path' => 'uploads/UpgradeAssetRequisition/ErrorLogs',
                'isactive' => true,
                'document_formats' => 'TXT,LOG,CSV,PDF',
                'max_upload_count' => 5,
                'created_at' => $now,
                'updated_at' => $now,
                'listable' => true,
            ...
            [
                'id' => 69,
                'document_category_id' => 31,
                'document_field_name' => "Screenshots/photos",
                'description' => "Screenshots capturing errors, system behavior, or relevant visual evidence",
                'file_path' => 'uploads/UpgradeAssetRequisition/Screenshots',
                'isactive' => true,
                'document_formats' => 'PNG,JPG,JPEG,SVG,GIF',
                'max_upload_count' => 5,
                'created_at' => $now,
                'updated_at' => $now,
                'listable' => true,
            ...
            [
                'id' => 70,
                'document_category_id' => 32,
                'document_field_name' => "Error Logs/Performance Reports",
                'description' => "System or application error logs or performance reports used for troubleshooting and debugging",
                'file_path' => 'uploads/ReplaceAssetRequisition/ErrorLogs',
                'isactive' => true,
                'document_formats' => 'TXT,LOG,CSV,PDF',
                'max_upload_count' => 5,
                'created_at' => $now,
            ...
            [
                ...
                'document_field_name' => "Screenshots/photos",
                'description' => "Screenshots capturing errors, system behavior, or relevant visual evidence",
                'file_path' => 'uploads/ReplaceAssetRequisition/Screenshots',
                'isactive' => true,
                'document_formats' => 'PNG,JPG,JPEG,SVG,GIF',
                'max_upload_count' => 5,
                'created_at' => $now,
