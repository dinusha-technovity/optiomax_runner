...
class AssetRequisitionLogTypeSeeder extends Seeder
{
    public function run(): void
    {
        $logTypes = [
            ...
            [
                'id' => 2,
                'code' => 'PENDING_REPLACEMENT_RECOMMENDATION',
                'name' => 'Pending Replacement Recommendation',
                'description' => 'Pending replacement recommendation',
            ],
            [
                'id' => 3,
            ...
            [
                'id' => 12,
                'code' => 'ASSET_REQUISITION_RESUMED',
                'name' => 'Asset Requisition Resumed',
                'description' => 'Requisition was resumed from on-hold status',
            ],
