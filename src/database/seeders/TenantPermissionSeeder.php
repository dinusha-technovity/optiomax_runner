    ...
    public function run(): void
    {
        ...
        $permission = [
            ...
            [
                'id' => 167,
                'name' => 'Decisions',
                'description' => 'workflow decisions management',
                'parent_id' => null,
                'menulink' => '#',  
                'icon' => 'FaBalanceScale',
                'isconfiguration' => false,
            ...
            [
                ...
                'description' => 'View executive reports',
                'parent_id' => 167,
                'menulink' => '/users_requisitions_list',
                'icon' => null,
                'isconfiguration' => false,
                'ismenu_list' => true,
                'menu_order' => 1,
            ...
            [
                'id' => 172,
                'name' => 'Asset Booking Requisition',
                'description' => 'View executive reports',
                'parent_id' => 167,
                'menulink' => '/users_requisitions_list',
                'icon' => null,
            ...
            [
                'id' => 173,
                'name' => 'Customer Registration Requisition',
                'description' => 'View executive reports',
                'parent_id' => 167,
                'menulink' => '/users_requisitions_list',
                'icon' => null,
            ...
            [
                'id' => 175,
                'name' => 'Asset Request from Owner Requisition',
                'description' => 'View executive reports',
                'parent_id' => 167,
                'menulink' => '/users_requisitions_list',
                'icon' => null,
